...
module ContactProcess
    ...
    function initialize_states_and_rates(width, height, initial_infections = 10)
        state = zeros(Bool, width, height)
        rates = zeros(width, height)
        # TODO: Add initial infections
    ...
    for _ in 1:initial_infections
        # randomly infect some individuals without replacement
